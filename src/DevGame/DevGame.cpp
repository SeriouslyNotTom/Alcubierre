...
//
//	bool has_hmd = vr::VR_IsHmdPresent();
//	
//
//	auto const samplingrate = 44100;
//	auto const framesize = 1024;
//
//	clear_col[0] = 0.07843137254901960784313725490196f; clear_col[1] = 0.0f; clear_col[2] = 0.15686274509803921568627450980392f; clear_col[3] = 0.0f;
//
